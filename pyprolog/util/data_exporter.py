...
class DataExporter:
    ...
    def _fact_to_json_object(self, fact: Fact) -> dict[str, Any]:
        ...
        return {"functor": functor_name, "args": json_args}
    ...
    def _get_functor_name(self, term: Term) -> str:
        ...
        if isinstance(functor, Atom):
            ...
            if (
                self.runtime
                and hasattr(self.runtime, "functor_mapper")
                and self.runtime.functor_mapper
            ):
                original_name = self.runtime.functor_mapper.map_english_to_non_ascii(
                    functor_name
                )
    ...
    def _term_to_string(self, term: PrologType) -> str:
        ...
        if isinstance(term, Atom):
            ...
            if (
                self.runtime
                and hasattr(self.runtime, "variable_mapper")
                and self.runtime.variable_mapper
            ):
                original_name = self.runtime.variable_mapper.map_english_to_japanese(
                    var_name
                )
                return original_name
    ...
    def _prolog_list_to_json_array(self, term: Term) -> list[Any]:
        ...
        while (
            ...
            and isinstance(current.functor, Atom)
