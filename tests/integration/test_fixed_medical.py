...
class TestFixedMedical(unittest.TestCase):
    ...
    def test_working_medical_diagnosis(self):
        ...
        result3 = self.runtime.query("patient_diagnosis([fever, cough], 30, [], [], Result).")
        ...
        solution3 = result3[0]
        assert result_var in solution3, "Variable Result not found in patient diagnosis solution"
