...
class TestBuiltInUnificationPredicates(unittest.TestCase):
    ...
    def test_non_unifiable_variable_ground(self):
        ...
        self.assertQueryFalse("X \\= a, X = a") # X=a, then a \= a -> false (This was correct)
    ...
    def test_non_unifiable_variables_unbound(self):
        ...
        self.assertQueryFalse("X \\= Y") # Standard: X and Y are unifiable, so X \= Y is false.
    ...
    def test_non_unifiable_compound_terms_args(self):
        ...
        self.assertQueryFalse("f(X) \\= f(Y), X=a, Y=a") # X=a, Y=a => f(a) \= f(a) -> false (This was correct)
