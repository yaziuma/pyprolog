...
class TestExportFactsPredicate:
    ...
    def test_export_facts_csv_basic(self):
        ...
        # export_facts/2を実行
        solutions = list(self.runtime.query(f"export_facts(person/2, '{output_file}')."))
    ...
    def test_export_facts_json_basic(self):
        ...
        solutions = list(self.runtime.query(f"export_facts(person/2, json('{output_file}'))."))
    ...
    def test_export_facts_tsv_basic(self):
        ...
        solutions = list(self.runtime.query(f"export_facts(animal/2, tsv('{output_file}'))."))
    ...
    def test_export_facts_only_facts_not_rules(self):
        ...
        # parent述語にはルールしかない
        solutions = list(self.runtime.query(f"export_facts(parent/2, '{output_file}')."))
    ...
    def test_export_facts_nonexistent_predicate(self):
        ...
        # 存在しない述語を指定
        solutions = list(self.runtime.query(f"export_facts(nonexistent/2, '{output_file}')."))
    ...
    def test_export_facts_invalid_file_path(self):
        ...
        # エラーが発生して失敗することを確認
        solutions = list(self.runtime.query(f"export_facts(person/2, '{invalid_path}')."))
    ...
    def test_export_facts_invalid_predicate_format(self):
        ...
        # 負のアリティ
        solutions = list(self.runtime.query(f"export_facts(person/(-1), '{output_file}')."))
    ...
    def test_export_facts_with_complex_terms(self):
        ...
        # JSON形式でエクスポート
        solutions = list(self.runtime.query(f"export_facts(data/2, json('{output_file}'))."))
...
class TestExportFactsEdgeCases:
    ...
    def test_export_facts_unicode_handling(self):
        ...
        solutions = list(self.runtime.query(f"export_facts(unicode/2, '{output_file}')."))
