...
class OperatorRegistry:
    ...
    def _initialize_builtin_operators(self):
        ...
        builtin_ops = [
            ...
            # 論理演算子
            OperatorInfo(
                "=", 700, Associativity.NON, OperatorType.LOGICAL, 2, None, "EQUAL"
            ),
            OperatorInfo(
                "\\=", 700, Associativity.NON, OperatorType.LOGICAL, 2, None, "NOTEQUAL"
            ),
            OperatorInfo(
                "==",
                700,
            ...
            OperatorInfo(
                "!", 200, Associativity.NON, OperatorType.CONTROL, 1, None, "CUT"
            ),
            # IO 演算子 (述語として扱うことが多いが、トークンタイプを生成するために登録)
            OperatorInfo(
                "write", 700, Associativity.NON, OperatorType.IO, 1, None, "WRITE"
            ),
            OperatorInfo("nl", 700, Associativity.NON, OperatorType.IO, 0, None, "NL"),
            OperatorInfo(
                "tab", 700, Associativity.NON, OperatorType.IO, 1, None, "TAB"
            ),
        ]
